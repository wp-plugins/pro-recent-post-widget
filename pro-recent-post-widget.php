...
class Pro_Recent_Post_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
     ...
     $r = new WP_Query( apply_filters( 'widget_posts_args', array( 'posts_per_page' => $number, 'no_found_rows' => true, 'post_status' => 'publish', 'ignore_sticky_posts' => true,'cat'=>$post_category ) ) );
	 //print_r($r);die();
	 if ($r->have_posts()) :
     ?>
